...
- [ai_agent/VERIFICATION_CHECKLIST.md](../VERIFICATION_CHECKLIST.md#-lint--code-quality-rubocop)
- [ai_agent/VERIFICATION_CHECKLIST.md](../VERIFICATION_CHECKLIST.md#-testing-requirements)
